...
export const docs = await create.docs("docs", "content/docs", {}, {"free-email-verification-tools.mdx": __fd_glob_0, "hello-world.mdx": __fd_glob_1, "how-to-verify-email-address.mdx": __fd_glob_2, "what-is-email-verification.mdx": __fd_glob_3, });