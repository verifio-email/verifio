    ...
    return (
        <div className="min-h-screen">
                        ...
                        {plans.map((plan, index) => (
                            ...
                            >
                                ...
                                <div className="mt-4 flex items-baseline">
                                    ...
                                    {plan.period && (
                                        <span className="ml-1 text-text-sub-600">{plan.period}</span>
                                    )}
                                </div>
            ...
            <section className="border-stroke-soft-100 border-b">
                <div className="mx-auto max-w-7xl border-stroke-soft-100 border-r border-l">
                    <div className="flex items-center justify-between border-stroke-soft-100 border-b px-10 py-4">
                        <span className="text-sm text-text-sub-600">[02] PAY AS YOU GO</span>
                        <span className="text-sm text-text-sub-600">
                            / ADDITIONAL CREDITS
                        </span>
                    </div>
                    <div className="grid gap-6 p-10 md:grid-cols-4">
                        {[
                            ...
                            >
                                ...
                                <p className="text-text-sub-600 text-xs">{tier.perEmail}/email</p>
                            </div>
                        ))}
                    </div>
                </div>
