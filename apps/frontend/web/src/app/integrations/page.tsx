...
const integrations = [
    {
        ...
        items: [
            ...
            { name: "Salesforce", desc: "Real-time lead verification", popular: true },
    ...
    return (
        <div className="min-h-screen">
            ...
            {integrations.map((category, catIndex) => (
                <section key={category.category} className="border-stroke-soft-100 border-b">
                    <div className="mx-auto max-w-7xl border-stroke-soft-100 border-r border-l">
                        <div className="flex items-center justify-between border-stroke-soft-100 border-b px-10 py-4">
                            <span className="text-sm text-text-sub-600">
                    ...
                    <div className="grid gap-0 md:grid-cols-2">
                        ...
                        <div className="flex items-center justify-center p-10">
                            <pre className="w-full overflow-x-auto rounded-lg bg-gray-900 p-6 text-sm text-green-400">
                                <code>
                                    {`curl -X POST \\
  https://api.verifio.com/v1/verify \\
