...
export default function VerifyOutlookEmailPage() {
	return (
		<div className="flex min-h-screen items-center justify-center">
			<div className="mx-auto max-w-2xl rounded-xl border border-stroke-soft-100 bg-white p-12 text-center">
				...
				<p className="mb-8 text-text-sub-600">
					Verify Outlook and Hotmail email addresses instantly. Use our free
					email verification tool to check if Outlook addresses are valid.
				</p>
				<Link
