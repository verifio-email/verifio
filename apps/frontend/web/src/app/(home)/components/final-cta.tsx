			...
			<div className="mx-auto max-w-5xl border-stroke-soft-100 border-r border-l">
				<div className="grid min-h-[280px] grid-cols-1 items-center gap-8 px-6 py-12 md:grid-cols-4 md:px-10 md:py-16">
					...
					<div className="col-span-3 flex flex-col items-center text-center md:items-start md:pr-20 md:text-left">
						<h2 className="max-w-lg font-medium text-text-strong-950 text-xl tracking-tight md:text-2xl lg:text-3xl">
						...
						<div className="mt-8 flex flex-wrap items-center justify-center gap-3 md:justify-start">
							<Link href="/signup">
								<Button.Root size="small">Start for free</Button.Root>
							</Link>
							<Link
					...
					<div className="border-stroke-soft-100 border-t pt-8 md:border-t-0 md:pt-0">
						<EmailCounter />
					</div>
				</div>
			</div>
