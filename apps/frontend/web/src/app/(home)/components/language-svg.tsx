...
const Ruby = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} preserveAspectRatio="xMidYMid" viewBox="0 0 256 255">
		...
		<path d="m52.7 254 29.7-97.1-65.2 13.9L52.7 254Z" fill="url(#ruby__d)" />
		...
		<path d="m0 203.4 18.2-33.2-14.7-39.5L0 203.4Z" fill="url(#ruby__h)" />
		<path
...
const Go = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} viewBox="0 0 207 78">
		<g fill="#05A8D0" fillRule="evenodd">
