...
export function MailServerSection({
	...
	return (
		<div className="border-stroke-soft-100/60 border-t dark:border-stroke-soft-100/40">
			<h4 className="flex items-center gap-2 border-stroke-soft-100/60 border-b px-6 py-4 font-semibold text-sm text-text-strong-950 dark:border-stroke-soft-100/40">
			...
			>
				...
				<div
					...
					className="relative flex items-center justify-between border-stroke-soft-100/60 border-b px-6 py-3 dark:border-stroke-soft-100/40"
				>
					<span className="flex items-center gap-2 text-sm text-text-sub-600">
