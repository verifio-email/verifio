...
function StatusCell({ value }: { value: boolean | string }) {
	if (value === true) {
		return <Icon name="check" className="h-4.5 w-4.5 text-success-base" />;
	}
					...
					<table className="w-full">
						...
						<thead>
							<tr className="border-stroke-soft-200/50 border-b">
								...
								<th className="w-[30%] border-stroke-soft-200/50 border-r px-4 py-6 text-center dark:bg-orange-500/5">
						...
						<tbody>
							{comparisonData.map((row, index) => (
								...
								>
									...
									{/* Verifio value */}
									<td className="flex items-center justify-center border-stroke-soft-200/50 border-r px-4 py-5">
