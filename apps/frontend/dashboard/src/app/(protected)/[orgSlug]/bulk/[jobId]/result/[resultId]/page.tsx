...
import { BulkEmailResultHeader } from "./components/bulk-email-result-header";
...
const BulkEmailResultDetailPage = () => {
...
export default BulkEmailResultDetailPage;
