...
export namespace ApiKeyModel {
	...
	export const verifyApiKeyResponse = t.Object({
		valid: t.Boolean({ description: "Whether the API key is valid" }),
		apiKey: t.Optional(
			t.Object({
				id: t.String({ description: "Unique API key identifier" }),
				name: t.Union([t.String(), t.Null()], {
	...
	export type VerifyApiKeyResponse = typeof verifyApiKeyResponse.static;
}
